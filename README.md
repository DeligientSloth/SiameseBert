...
*   Longer sequences are disproportionately expensive because attention is
    ...
    length 128. The fully-connected/convolutional t is the same, but the
    attention t is far greater for the 512-length sequences. Therefore, one
...
*   If you are pre-training from scratch, be prepared that pre-training is
    ...
    takes about 2 weeks at a t of about $500 USD (based on the pricing in
